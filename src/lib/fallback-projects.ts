...
// Static fallback projects (used when D1 is not available)
// Uses plain string paths instead of Vite asset imports to avoid SSR bundler issues
export const fallbackProjects: Project[] = [
  {
    ...
    coverImage: "/assets/electrical.jpg",
    images: ["/assets/electrical.jpg"],
  },
  {
    ...
    coverImage: "/assets/solar.jpg",
    images: ["/assets/solar.jpg"],
  },
  {
    ...
    coverImage: "/assets/fire.jpg",
    images: ["/assets/fire.jpg"],
  },
  {
