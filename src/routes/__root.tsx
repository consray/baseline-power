...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Baseline Power Systems | Electrical, Solar & Fire Safety in Kenya" },
      {
        name: "description",
        content:
          "Licensed electrical, solar and fire safety contractors serving residential, commercial, industrial and government clients across all 47 Kenyan counties.",
      },
      {
        property: "og:title",
